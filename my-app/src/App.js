...
mapboxgl.accessToken = 'pk.eyJ1IjoiamhhNTgiLCJhIjoiY200NGw3azJxMDA1dTJqcHpvczVhanRmOSJ9.efEjDtitrtESy5oLFc5J8w';  // Replace with your actual token
...
const App = () => {
  ...
  const searchLocation = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(locationInput)}.json?access_token=${mapboxgl.accessToken}`
      );
  ...
  return (
    <div>
      <div id="controls">
        <input id="location" type="text" placeholder="Enter ZIP Code or City" />
